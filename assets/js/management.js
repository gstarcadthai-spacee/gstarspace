...
async function saveProduct(){
  ...
  const payload={Name:pName.value.trim(),Category:pCategory.value,Description:pDesc.value.trim(),CurrentVersion:pVersion.value.trim(),Platform:pPlatform.value.trim(),License:pLicense.value.trim(),WebsiteURL:pWebsite.value.trim(),Status:pStatus.value,OpenTicketURL:'https://cs.applicadthai.com/'};
